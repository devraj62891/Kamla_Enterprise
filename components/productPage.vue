<template>
  <div class="h-[100vh] items-center">
    ...
    <div
      class="cardSection flex gap-6 justify-center p-3 md:flex-row flex-col items-center pb-3 mb-2"
    >
      <card
        image="/steep_core.jpg"
        heading="Steep Core"
        description="This is a steep core"
      />
    ...
    >
      <div class="address">
        ...
        <div
          class="tellUs mt-10 ml-10 items-center justify-center align-middle flex"
        >
          <div >
            <form
              ref="form"
              @submit.prevent="sendEmail"
              class="border rounded p-2 bg-pink-50 flex flex-col items-center"
            >
              ...
              <input
                type="submit"
                value="Send"
                class="ml-3.5 bg-pink-400 hover:scale-95 hover:bg-pink-500 transition-transform text-white px-4 py-2 rounded cursor-pointer"
              />
              <div
                v-if="status"
